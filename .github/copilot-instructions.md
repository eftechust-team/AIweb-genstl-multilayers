...
- [x] Scaffold the Project
	Created Flask app with basic structure for multi-layer STL generator.

- [x] Customize the Project
	Implemented basic UI and backend for image generation, editing, and STL creation with placeholders.
...
- [x] Create and Run Task
	Created and ran task to start Flask server.
